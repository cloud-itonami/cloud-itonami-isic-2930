# Operator Quickstart — Manufacture of Parts and Accessories for Motor Vehicles

Shortest path from clone to a verified local dry-run for **ISIC 2930** (`cloud-itonami-isic-2930`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2930.git
cd cloud-itonami-isic-2930
```
...
- Blueprint governor key: `autoparts-governor`
- Likely source path: `autoparts.governor.cljc`
